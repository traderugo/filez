    ...
    return (
      <div className="max-w-sm mx-auto px-4 py-20">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-content">Password updated</h1>
          <p className="text-sm text-content-muted mt-2">Redirecting to login...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-sm mx-auto px-4 py-20">
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-content-muted mt-1">Enter your new password below</p>
      </div>
