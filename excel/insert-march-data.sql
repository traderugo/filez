-- =============================================================================
-- Insert Daily Sales data for March 1–7, 2026
-- Station: RAINOIL LUCKY WAY (467559c8-c0ad-48ca-b3f7-9fc2a35f7f92)
-- =============================================================================
-- Run migration 023_prices_jsonb.sql FIRST, then run this.
-- =============================================================================
...
DECLARE
  ...
  -- Banks (all STANBIC POS, mapped in order)
...
BEGIN
  ...
  RAISE NOTICE 'Done — inserted 7 daily sales entries + 21 POS lodgement entries for RAINOIL LUCKY WAY';
END $$;
