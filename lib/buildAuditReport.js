...
function buildFuelMeterRows(fuelType, ftNozzles, pumpIds, rangeEntries, prevEntry) {
  ...
  for (const entry of rangeEntries) {
    // Update closing meters first — this entry's readings close the current price period
    ...
    // Then check if price changed — emit the now-closed former period, open a new one
