 ...
 * @param {number[]} delivery.chartUllage - [comp1, comp2, comp3]
...
export async function exportProductReceiptExcel(delivery) {
  ...
  const ullageChart = Array.isArray(d.chartUllage) ? d.chartUllage : [d.chartUllage, d.chartUllage, d.chartUllage]
