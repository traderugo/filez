 ...
 *     chartUllage1-3, chartLiquidHeight1-3, depotUllage1-3, depotLiquidHeight1-3,
  ...
  const dates = dateStrings.map(date => {
    ...
    const receipts = dayReceipts.map(r => {
      ...
      return {
        ...
        chartUllage1: Number(r.chartUllage1 || 0),
        chartUllage2: Number(r.chartUllage2 || 0),
        chartUllage3: Number(r.chartUllage3 || 0),
