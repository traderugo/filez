 ...
 */
export async function exportImprestExcel({ month, year, imprestAmount, custodianName, formNumber, entries, totalSpent, balance, stationName, stationCode, preparedBy, paidBy }) {
  ...
  // Row 45: Preparer name (left) + Paid By name (right)
  ws.getRow(45).height = 16.5
  sc(ws, 45, 3, preparedBy || '', FONT_CORBEL, YELLOW_FILL, ALIGN_LM_WRAP, { left: MED(), top: MED(), bottom: MED() })
  sc(ws, 45, 4, null, FONT_CORBEL, YELLOW_FILL, ALIGN_LM_WRAP, { top: MED(), bottom: MED() })
  ws.mergeCells('C45:D45')
  sc(ws, 45, 12, paidBy || '', FONT_CORBEL, YELLOW_FILL, { vertical: 'middle' }, { left: MED(), top: MED(), bottom: MED() })
  sc(ws, 45, 13, null, FONT_CORBEL, YELLOW_FILL, { vertical: 'middle' }, { top: MED(), bottom: MED() })
  sc(ws, 45, 14, null, FONT_CORBEL, YELLOW_FILL, { vertical: 'middle' }, { top: MED(), bottom: MED() })
  ws.mergeCells('L45:N45')
  for (let c = 15; c <= 19; c++) sc(ws, 45, c, null, FONT_CORBEL, NO_FILL, null, null)
  ws.mergeCells('O45:S45')

  // Row 46: Signature area (left) + Signature area (right)
  ...
  sc(ws, 46, 12, '', FONT_CORBEL, YELLOW_FILL, { vertical: 'middle' }, { left: MED(), top: MED(), bottom: MED() })
  sc(ws, 46, 13, null, FONT_CORBEL, YELLOW_FILL, { vertical: 'middle' }, { top: MED(), bottom: MED() })
  sc(ws, 46, 14, null, FONT_CORBEL, YELLOW_FILL, { vertical: 'middle' }, { top: MED(), bottom: MED() })
  ws.mergeCells('L46:N46')
  for (let c = 15; c <= 19; c++) sc(ws, 46, c, null, FONT_CORBEL, NO_FILL, null, null)
  ws.mergeCells('O46:S46')

  // Row 47: Date (left) + Date (right)
  ws.getRow(47).height = 16.5
  sc(ws, 47, 3, dateStr, FONT_CORBEL, YELLOW_FILL, ALIGN_LM_WRAP, { left: MED(), top: MED(), bottom: MED() })
  sc(ws, 47, 4, null, FONT_CORBEL, YELLOW_FILL, ALIGN_LM_WRAP, { top: MED(), bottom: MED() })
  ws.mergeCells('C47:D47')
  sc(ws, 47, 12, '', FONT_CORBEL, YELLOW_FILL, { vertical: 'middle', wrapText: true }, { left: MED(), top: MED(), bottom: MED() })
  sc(ws, 47, 13, null, FONT_CORBEL, YELLOW_FILL, { vertical: 'middle', wrapText: true }, { top: MED(), bottom: MED() })
  sc(ws, 47, 14, null, FONT_CORBEL, YELLOW_FILL, { vertical: 'middle', wrapText: true }, { top: MED(), bottom: MED() })
  ...
  sc(ws, 52, 3, dateStr, FONT_CORBEL, YELLOW_FILL, ALIGN_LM_WRAP, { left: MED(), top: MED(), bottom: MED() })
