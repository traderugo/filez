...
function setHeaderRowHeights(ws) {
  ws.getRow(4).height  = 48 // fuel headers ("Total Actual Sales (Ltrs)", "Actual Sales @P1")
  ws.getRow(10).height = 48 // stock headers ("Waybill Qty Supplied", "Actual Qty Received")
  ws.getRow(20).height = 36 // deposit + POS headers
  ws.getRow(24).height = 48 // cash headers ("Previous Day Cash @ Hand", "Expected Cash @ Hand")
  ws.getRow(27).height = 36 // budget headers + long comment header
  ws.getRow(33).height = 36 // competitor headers
  ws.getRow(38).height = 48 // lube headers ("Opening Stock Units", "Product Supply Units")
}
