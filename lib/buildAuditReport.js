 ...
 *
 * Sequential walk through ALL entries (ignoring dates).
 * Accumulate readings at the current price. When price changes,
...
function buildFuelMeterRows(fuelType, nozzles, allSorted, prevEntry, dateStrings, entriesByDate) {
  ...
  // Sequential walk — emit a row whenever price changes
