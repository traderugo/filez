  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 text-center">
      <div className="w-12 h-12 rounded-full bg-subtle flex items-center justify-center mb-4">
        <svg className="w-6 h-6 text-content-faint" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <h1 className="text-lg font-semibold text-content mb-1">You are offline</h1>
      <p className="text-sm text-content-muted mb-6 max-w-xs">
