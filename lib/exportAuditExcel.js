...
function writeGuideline(wb, logoId) {
  ...
  // Logo — top-right area (col C-D, rows 1-3)
  if (logoId !== null) {
    ws.addImage(logoId, { tl: { col: 3.0, row: 0.83 }, br: { col: 4.0, row: 3.42 }, editAs: 'oneCell' })
  }
}
...
function writeSalesCash(wb, report, stationName, startDate, endDate, refs, logoId) {
  ...
  // Logo — top-right (col F-H, rows 1-3)
  if (logoId !== null) {
    ws.addImage(logoId, { tl: { col: 6.0, row: 0.77 }, br: { col: 8.0, row: 3.30 }, editAs: 'oneCell' })
  }
...
function writeStockPosition(wb, report, stationName, startDate, endDate, refs, logoId) {
  ...
  // Logo — top-right (col D-E, rows 2-3)
  if (logoId !== null) {
    ws.addImage(logoId, { tl: { col: 4.0, row: 1.25 }, br: { col: 5.0, row: 3.37 }, editAs: 'oneCell' })
  }
...
function writeLodgement(wb, report, stationName, startDate, endDate, refs, logoId) {
  ...
  // Logo — top-right (col G-I, rows 2-4)
  if (logoId !== null) {
    ws.addImage(logoId, { tl: { col: 6.0, row: 1.0 }, br: { col: 9.0, row: 3.77 }, editAs: 'oneCell' })
  }
